...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->venoznaya->Location = System::Drawing::Point(1156, 714);
			this->venoznaya->Name = L"venoznaya";
			this->venoznaya->Size = System::Drawing::Size(228, 713);
			this->venoznaya->TabIndex = 17;
			...
			this->nijpolayavena->Click += gcnew System::EventHandler(this, &MyForm3::nijpolayavena_Click);
			// 
			// venynog
			// 
			...
			this->venynog->Size = System::Drawing::Size(144, 344);
			this->venynog->TabIndex = 5;
			this->venynog->UseVisualStyleBackColor = true;
			this->venynog->Click += gcnew System::EventHandler(this, &MyForm3::venynog_Click);
			// 
			// venyruk2
			// 
			...
			this->venyruk2->Click += gcnew System::EventHandler(this, &MyForm3::venyruk2_Click);
			// 
			// venyruk1
			// 
			...
			this->venyruk1->Click += gcnew System::EventHandler(this, &MyForm3::venyruk1_Click);
			// 
			// plechevyveny
			// 
			...
			this->plechevyveny->Click += gcnew System::EventHandler(this, &MyForm3::plechevyveny_Click);
			// 
			// yaremnyveny
			// 
			...
			this->yaremnyveny->Click += gcnew System::EventHandler(this, &MyForm3::yaremnyveny_Click);
			// 
			// venycherep
			// 
			...
			this->venycherep->Location = System::Drawing::Point(70, 9);
			this->venycherep->Name = L"venycherep";
			this->venycherep->Size = System::Drawing::Size(82, 78);
			this->venycherep->TabIndex = 0;
			this->venycherep->UseVisualStyleBackColor = true;
			this->venycherep->Click += gcnew System::EventHandler(this, &MyForm3::venycherep_Click);
			// 
			// arterialnaya
			// 
			...
			this->nogiart->Click += gcnew System::EventHandler(this, &MyForm3::nogiart_Click);
			// 
			// tazart
			// 
			...
			this->tazart->Click += gcnew System::EventHandler(this, &MyForm3::tazart_Click);
			// 
			// ruka2art
			// 
			...
			this->ruka2art->Click += gcnew System::EventHandler(this, &MyForm3::ruka2art_Click);
			// 
			// ryka1art
			// 
			...
			this->ryka1art->Click += gcnew System::EventHandler(this, &MyForm3::ryka1art_Click);
			// 
			// mejrebernart
			// 
			...
			this->mejrebernart->Location = System::Drawing::Point(57, 143);
			this->mejrebernart->Name = L"mejrebernart";
			this->mejrebernart->Size = System::Drawing::Size(104, 105);
			this->mejrebernart->TabIndex = 4;
			this->mejrebernart->UseVisualStyleBackColor = true;
			this->mejrebernart->Click += gcnew System::EventHandler(this, &MyForm3::mejrebernart_Click);
			// 
			// plechevyart
			// 
			...
			this->plechevyart->Click += gcnew System::EventHandler(this, &MyForm3::plechevyart_Click);
			// 
			// aorta
			// 
			...
			this->aorta->Click += gcnew System::EventHandler(this, &MyForm3::aorta_Click);
			// 
			// sonnayaart
			// 
			...
			this->sonnayaart->Location = System::Drawing::Point(78, 75);
			this->sonnayaart->Name = L"sonnayaart";
			this->sonnayaart->Size = System::Drawing::Size(54, 44);
			this->sonnayaart->TabIndex = 1;
			this->sonnayaart->UseVisualStyleBackColor = true;
			this->sonnayaart->Click += gcnew System::EventHandler(this, &MyForm3::sonnayaart_Click);
			// 
			// mozgart
			// 
			...
			this->mozgart->Size = System::Drawing::Size(73, 65);
			this->mozgart->TabIndex = 0;
			this->mozgart->UseVisualStyleBackColor = true;
			this->mozgart->Click += gcnew System::EventHandler(this, &MyForm3::mozgart_Click);
			// 
			// mishechnaya
			// 
			...
			this->stopmishtsi->Location = System::Drawing::Point(31, 669);
			this->stopmishtsi->Name = L"stopmishtsi";
			this->stopmishtsi->Size = System::Drawing::Size(452, 49);
			this->stopmishtsi->TabIndex = 20;
			this->stopmishtsi->UseVisualStyleBackColor = true;
			this->stopmishtsi->Click += gcnew System::EventHandler(this, &MyForm3::stopmishtsi_Click);
			// 
			// golenimishtsi
			// 
			...
			this->golenimishtsi->Location = System::Drawing::Point(44, 504);
			this->golenimishtsi->Name = L"golenimishtsi";
			this->golenimishtsi->Size = System::Drawing::Size(424, 165);
			this->golenimishtsi->TabIndex = 19;
			this->golenimishtsi->UseVisualStyleBackColor = true;
			this->golenimishtsi->Click += gcnew System::EventHandler(this, &MyForm3::golenimishtsi_Click);
			// 
			// bedramishtsi2
			// 
			...
			this->bedramishtsi2->Location = System::Drawing::Point(318, 408);
			this->bedramishtsi2->Name = L"bedramishtsi2";
			this->bedramishtsi2->Size = System::Drawing::Size(152, 127);
			this->bedramishtsi2->TabIndex = 18;
			this->bedramishtsi2->UseVisualStyleBackColor = true;
			this->bedramishtsi2->Click += gcnew System::EventHandler(this, &MyForm3::bedramishtsi2_Click);
			// 
			// bedromishtsi1
			// 
			...
			this->bedromishtsi1->Location = System::Drawing::Point(31, 357);
			...
			this->bedromishtsi1->Click += gcnew System::EventHandler(this, &MyForm3::bedromishtsi1_Click);
			// 
			// kistimishtsi3
			// 
			...
			this->kistimishtsi3->Location = System::Drawing::Point(468, 357);
			...
			this->kistimishtsi3->Click += gcnew System::EventHandler(this, &MyForm3::kistimishtsi3_Click);
			// 
			// kistimishtsi2
			// 
			...
			this->kistimishtsi2->Location = System::Drawing::Point(189, 357);
			...
			this->kistimishtsi2->Click += gcnew System::EventHandler(this, &MyForm3::kistimishtsi2_Click);
			// 
			// kistimishtsi1
			// 
			...
			this->kistimishtsi1->Click += gcnew System::EventHandler(this, &MyForm3::kistimishtsi1_Click);
			// 
			// predplechmishtsi3
			// 
			...
			this->predplechmishtsi3->Click += gcnew System::EventHandler(this, &MyForm3::predplechmishtsi3_Click);
			// 
			// predplechmishtsi2
			// 
			...
			this->predplechmishtsi2->Location = System::Drawing::Point(174, 247);
			...
			this->predplechmishtsi2->Click += gcnew System::EventHandler(this, &MyForm3::predplechmishtsi2_Click);
			// 
			// predplechmishtsi1
			// 
			...
			this->predplechmishtsi1->Location = System::Drawing::Point(3, 263);
			...
			this->predplechmishtsi1->Click += gcnew System::EventHandler(this, &MyForm3::predplechmishtsi1_Click);
			// 
			// trapetsevidnye
			// 
			...
			this->trapetsevidnye->Location = System::Drawing::Point(335, 123);
			...
			this->trapetsevidnye->Click += gcnew System::EventHandler(this, &MyForm3::trapetsevidnye_Click);
			// 
			// bitseps3
			// 
			...
			this->bitseps3->Click += gcnew System::EventHandler(this, &MyForm3::bitseps3_Click);
			// 
			// bitseps2
			// 
			...
			this->bitseps2->Size = System::Drawing::Size(147, 114);
			this->bitseps2->TabIndex = 8;
			this->bitseps2->UseVisualStyleBackColor = true;
			this->bitseps2->Click += gcnew System::EventHandler(this, &MyForm3::bitseps2_Click);
			// 
			// bitseps1
			// 
			...
			this->bitseps1->Location = System::Drawing::Point(3, 133);
			this->bitseps1->Name = L"bitseps1";
			this->bitseps1->Size = System::Drawing::Size(56, 124);
			this->bitseps1->TabIndex = 7;
			this->bitseps1->UseVisualStyleBackColor = true;
			this->bitseps1->Click += gcnew System::EventHandler(this, &MyForm3::bitseps1_Click);
			// 
			// yagodichniyemishtsi
			// 
			...
			this->yagodichniyemishtsi->Location = System::Drawing::Point(316, 336);
			this->yagodichniyemishtsi->Name = L"yagodichniyemishtsi";
			this->yagodichniyemishtsi->Size = System::Drawing::Size(146, 83);
			this->yagodichniyemishtsi->TabIndex = 6;
			this->yagodichniyemishtsi->UseVisualStyleBackColor = true;
			this->yagodichniyemishtsi->Click += gcnew System::EventHandler(this, &MyForm3::yagodichniyemishtsi_Click);
			// 
			// tazmishtsi
			// 
			...
			this->tazmishtsi->Size = System::Drawing::Size(117, 88);
			this->tazmishtsi->TabIndex = 5;
			this->tazmishtsi->UseVisualStyleBackColor = true;
			this->tazmishtsi->Click += gcnew System::EventHandler(this, &MyForm3::tazmishtsi_Click);
			// 
			// press
			// 
			...
			this->press->Location = System::Drawing::Point(52, 198);
			...
			this->press->Click += gcnew System::EventHandler(this, &MyForm3::press_Click);
			// 
			// mishtsispini
			// 
			...
			this->mishtsispini->Location = System::Drawing::Point(335, 180);
			this->mishtsispini->Name = L"mishtsispini";
			this->mishtsispini->Size = System::Drawing::Size(112, 150);
			this->mishtsispini->TabIndex = 3;
			this->mishtsispini->UseVisualStyleBackColor = true;
			this->mishtsispini->Click += gcnew System::EventHandler(this, &MyForm3::mishtsispini_Click);
			// 
			// grydniyemishtsi
			// 
			...
			this->grydniyemishtsi->Location = System::Drawing::Point(52, 133);
			...
			this->grydniyemishtsi->Click += gcnew System::EventHandler(this, &MyForm3::grydniyemishtsi_Click);
			// 
			// mishtsineck
			// 
			...
			this->mishtsineck->Location = System::Drawing::Point(77, 86);
			...
			this->mishtsineck->Click += gcnew System::EventHandler(this, &MyForm3::mishtsineck_Click);
			// 
			// mishtsilica
			// 
			...
			this->mishtsilica->Location = System::Drawing::Point(77, 14);
			...
			this->mishtsilica->Click += gcnew System::EventHandler(this, &MyForm3::mishtsilica_Click);
			// 
			// nervi
			// 
			...
			this->nervi->Location = System::Drawing::Point(329, 714);
			this->nervi->Name = L"nervi";
			this->nervi->Size = System::Drawing::Size(349, 710);
			this->nervi->TabIndex = 20;
			...
			this->spinnoy->Click += gcnew System::EventHandler(this, &MyForm3::spinnoy_Click);
			// 
			// handsnerv2
			// 
			...
			this->handsnerv2->Click += gcnew System::EventHandler(this, &MyForm3::handsnerv2_Click);
			// 
			// handsnerv1
			// 
			...
			this->handsnerv1->Click += gcnew System::EventHandler(this, &MyForm3::handsnerv1_Click);
			// 
			// plechevy
			// 
			...
			this->plechevy->Click += gcnew System::EventHandler(this, &MyForm3::plechevy_Click);
			// 
			// mejreberny
			// 
			...
			this->mejreberny->Click += gcnew System::EventHandler(this, &MyForm3::mejreberny_Click);
			// 
			// poyasnichny
			// 
			...
			this->poyasnichny->Click += gcnew System::EventHandler(this, &MyForm3::poyasnichny_Click);
			// 
			// bedrenny
			// 
			...
			this->bedrenny->Click += gcnew System::EventHandler(this, &MyForm3::bedrenny_Click);
			// 
			// sedalishniy
			// 
			...
			this->sedalishniy->Click += gcnew System::EventHandler(this, &MyForm3::sedalishniy_Click);
			// 
			// nervigoleni
			// 
			...
			this->nervigoleni->Click += gcnew System::EventHandler(this, &MyForm3::nervigoleni_Click);
			// 
			// skelet
			// 
			...
			this->skelet->Location = System::Drawing::Point(558, 7);
			this->skelet->Name = L"skelet";
			this->skelet->Size = System::Drawing::Size(612, 724);
			this->skelet->TabIndex = 21;
			...
			this->stopy->Location = System::Drawing::Point(126, 669);
			this->stopy->Name = L"stopy";
			this->stopy->Size = System::Drawing::Size(370, 45);
			this->stopy->TabIndex = 25;
			this->stopy->UseVisualStyleBackColor = false;
			this->stopy->Click += gcnew System::EventHandler(this, &MyForm3::stopy_Click);
			// 
			// goleni
			// 
			...
			this->goleni->Location = System::Drawing::Point(126, 518);
			this->goleni->Name = L"goleni";
			this->goleni->Size = System::Drawing::Size(357, 154);
			this->goleni->TabIndex = 24;
			this->goleni->UseVisualStyleBackColor = false;
			this->goleni->Click += gcnew System::EventHandler(this, &MyForm3::goleni_Click);
			// 
			// bedra2
			// 
			...
			this->bedra2->Location = System::Drawing::Point(369, 349);
			...
			this->bedra2->Click += gcnew System::EventHandler(this, &MyForm3::bedra2_Click);
			// 
			// bedra1
			// 
			...
			this->bedra1->Location = System::Drawing::Point(116, 355);
			this->bedra1->Name = L"bedra1";
			this->bedra1->Size = System::Drawing::Size(137, 141);
			this->bedra1->TabIndex = 22;
			this->bedra1->UseVisualStyleBackColor = false;
			this->bedra1->Click += gcnew System::EventHandler(this, &MyForm3::bedra1_Click);
			// 
			// ladon22
			// 
			...
			this->ladon22->Location = System::Drawing::Point(508, 338);
			...
			this->ladon22->Click += gcnew System::EventHandler(this, &MyForm3::ladon22_Click_1);
			// 
			// ladon21
			// 
			...
			this->ladon21->Size = System::Drawing::Size(103, 75);
			this->ladon21->TabIndex = 19;
			this->ladon21->UseVisualStyleBackColor = false;
			this->ladon21->Click += gcnew System::EventHandler(this, &MyForm3::ladon21_Click_1);
			// 
			// ladon11
			// 
			...
			this->ladon11->Location = System::Drawing::Point(55, 338);
			...
			this->ladon11->Click += gcnew System::EventHandler(this, &MyForm3::ladon11_Click);
			// 
			// predplech22
			// 
			...
			this->predplech22->Location = System::Drawing::Point(508, 252);
			...
			this->predplech22->Click += gcnew System::EventHandler(this, &MyForm3::predplech22_Click);
			// 
			// predplech21
			// 
			...
			this->predplech21->Location = System::Drawing::Point(258, 252);
			this->predplech21->Name = L"predplech21";
			this->predplech21->Size = System::Drawing::Size(116, 91);
			this->predplech21->TabIndex = 15;
			this->predplech21->UseVisualStyleBackColor = false;
			this->predplech21->Click += gcnew System::EventHandler(this, &MyForm3::predplech21_Click);
			// 
			// predplech11
			// 
			...
			this->predplech11->Location = System::Drawing::Point(73, 252);
			...
			this->predplech11->Click += gcnew System::EventHandler(this, &MyForm3::predplech11_Click);
			// 
			// plecho22
			// 
			...
			this->plecho22->Location = System::Drawing::Point(500, 144);
			this->plecho22->Name = L"plecho22";
			this->plecho22->Size = System::Drawing::Size(32, 110);
			this->plecho22->TabIndex = 13;
			this->plecho22->UseVisualStyleBackColor = false;
			this->plecho22->Click += gcnew System::EventHandler(this, &MyForm3::plecho22_Click);
			// 
			// plecho21
			// 
			...
			this->plecho21->Location = System::Drawing::Point(238, 139);
			this->plecho21->Name = L"plecho21";
			this->plecho21->Size = System::Drawing::Size(136, 115);
			this->plecho21->TabIndex = 12;
			this->plecho21->UseVisualStyleBackColor = false;
			this->plecho21->Click += gcnew System::EventHandler(this, &MyForm3::plecho21_Click);
			// 
			// plecho11
			// 
			...
			this->plecho11->Location = System::Drawing::Point(73, 141);
			...
			this->plecho11->Click += gcnew System::EventHandler(this, &MyForm3::plecho11_Click);
			// 
			// lopatki
			// 
			...
			this->lopatki->Location = System::Drawing::Point(367, 117);
			this->lopatki->Name = L"lopatki";
			this->lopatki->Size = System::Drawing::Size(129, 55);
			this->lopatki->TabIndex = 9;
			this->lopatki->UseVisualStyleBackColor = false;
			this->lopatki->Click += gcnew System::EventHandler(this, &MyForm3::lopatki_Click);
			// 
			// kluychitsi
			// 
			...
			this->kluychitsi->Location = System::Drawing::Point(104, 117);
			...
			this->kluychitsi->Click += gcnew System::EventHandler(this, &MyForm3::kluychitsi_Click);
			// 
			// rebra2
			// 
			...
			this->rebra2->Location = System::Drawing::Point(380, 162);
			...
			this->rebra2->Click += gcnew System::EventHandler(this, &MyForm3::rebra2_Click);
			// 
			// rebra1
			// 
			...
			this->rebra1->Location = System::Drawing::Point(126, 139);
			...
			this->rebra1->Click += gcnew System::EventHandler(this, &MyForm3::rebra1_Click);
			// 
			// taz2
			// 
			...
			this->taz2->Location = System::Drawing::Point(375, 289);
			...
			this->taz2->Click += gcnew System::EventHandler(this, &MyForm3::taz2_Click);
			// 
			// taz1
			// 
			...
			this->taz1->Location = System::Drawing::Point(133, 289);
			...
			this->taz1->Click += gcnew System::EventHandler(this, &MyForm3::taz1_Click);
			// 
			// pozvon2
			// 
			...
			this->pozvon2->Location = System::Drawing::Point(417, 85);
			...
			this->pozvon2->Click += gcnew System::EventHandler(this, &MyForm3::pozvon2_Click);
			// 
			// pozvon1
			// 
			...
			this->pozvon1->Location = System::Drawing::Point(171, 97);
			...
			this->pozvon1->Click += gcnew System::EventHandler(this, &MyForm3::pozvon1_Click);
			// 
			// cherep2
			// 
			...
			this->cherep2->Location = System::Drawing::Point(403, -3);
			...
			this->cherep2->Click += gcnew System::EventHandler(this, &MyForm3::cherep2_Click);
			// 
			// cherep1
			// 
			...
			this->cherep1->Location = System::Drawing::Point(153, 5);
			...
			this->cherep1->Click += gcnew System::EventHandler(this, &MyForm3::cherep1_Click);
			// 
			// limfa
			// 
			...
			this->limfa->Location = System::Drawing::Point(1127, 697);
			this->limfa->Name = L"limfa";
			this->limfa->Size = System::Drawing::Size(241, 712);
			this->limfa->TabIndex = 22;
			...
			this->nizlimfa->Click += gcnew System::EventHandler(this, &MyForm3::nizlimfa_Click);
			// 
			// verh2limfa
			// 
			...
			this->verh2limfa->Location = System::Drawing::Point(180, 202);
			this->verh2limfa->Name = L"verh2limfa";
			this->verh2limfa->Size = System::Drawing::Size(44, 192);
			this->verh2limfa->TabIndex = 12;
			this->verh2limfa->UseVisualStyleBackColor = true;
			this->verh2limfa->Click += gcnew System::EventHandler(this, &MyForm3::verh2limfa_Click);
			// 
			// verh1limfa
			// 
			...
			this->verh1limfa->Click += gcnew System::EventHandler(this, &MyForm3::verh1limfa_Click);
			// 
			// poyasnitsalimfa
			// 
			...
			this->poyasnitsalimfa->Click += gcnew System::EventHandler(this, &MyForm3::poyasnitsalimfa_Click);
			// 
			// timus
			// 
			...
			this->timus->Location = System::Drawing::Point(102, 128);
			this->timus->Name = L"timus";
			this->timus->Size = System::Drawing::Size(29, 34);
			this->timus->TabIndex = 9;
			this->timus->UseVisualStyleBackColor = true;
			this->timus->Click += gcnew System::EventHandler(this, &MyForm3::timus_Click);
			// 
			// mindaliny
			// 
			...
			this->mindaliny->Click += gcnew System::EventHandler(this, &MyForm3::mindaliny_Click);
			// 
			// selezenka
			// 
			...
			this->selezenka->Location = System::Drawing::Point(137, 220);
			this->selezenka->Name = L"selezenka";
			this->selezenka->Size = System::Drawing::Size(23, 44);
			this->selezenka->TabIndex = 7;
			this->selezenka->UseVisualStyleBackColor = true;
			this->selezenka->Click += gcnew System::EventHandler(this, &MyForm3::selezenka_Click);
			// 
			// grudlimfa
			// 
			...
			this->grudlimfa->Size = System::Drawing::Size(56, 94);
			this->grudlimfa->TabIndex = 6;
			this->grudlimfa->UseVisualStyleBackColor = true;
			this->grudlimfa->Click += gcnew System::EventHandler(this, &MyForm3::grudlimfa_Click);
			// 
			// qisternalimfa
			// 
			...
			this->qisternalimfa->Location = System::Drawing::Point(102, 247);
			this->qisternalimfa->Name = L"qisternalimfa";
			this->qisternalimfa->Size = System::Drawing::Size(29, 52);
			this->qisternalimfa->TabIndex = 5;
			this->qisternalimfa->UseVisualStyleBackColor = true;
			this->qisternalimfa->Click += gcnew System::EventHandler(this, &MyForm3::qisternalimfa_Click);
			// 
			// pahlimfa
			// 
			...
			this->pahlimfa->Location = System::Drawing::Point(45, 348);
			this->pahlimfa->Name = L"pahlimfa";
			this->pahlimfa->Size = System::Drawing::Size(133, 51);
			this->pahlimfa->TabIndex = 4;
			this->pahlimfa->UseVisualStyleBackColor = true;
			this->pahlimfa->Click += gcnew System::EventHandler(this, &MyForm3::pahlimfa_Click);
			// 
			// podmish2limfa
			// 
			...
			this->podmish2limfa->Size = System::Drawing::Size(48, 66);
			this->podmish2limfa->TabIndex = 3;
			this->podmish2limfa->UseVisualStyleBackColor = true;
			this->podmish2limfa->Click += gcnew System::EventHandler(this, &MyForm3::podmish2limfa_Click);
			// 
			// podmash1limfa
			// 
			...
			this->podmash1limfa->Size = System::Drawing::Size(48, 66);
			this->podmash1limfa->TabIndex = 2;
			this->podmash1limfa->UseVisualStyleBackColor = true;
			this->podmash1limfa->Click += gcnew System::EventHandler(this, &MyForm3::podmash1limfa_Click);
			// 
			// kluychitsilimfa
			// 
			...
			this->sheialimfa->Click += gcnew System::EventHandler(this, &MyForm3::sheialimfa_Click);
			// 
			// reproduct
			// 
			...
			this->reproduct->Location = System::Drawing::Point(696, 709);
			this->reproduct->Name = L"reproduct";
			this->reproduct->Size = System::Drawing::Size(271, 324);
			this->reproduct->TabIndex = 23;
			...
			this->yaichnick1->Location = System::Drawing::Point(3, 120);
			this->yaichnick1->Name = L"yaichnick1";
			this->yaichnick1->Size = System::Drawing::Size(97, 166);
			this->yaichnick1->TabIndex = 3;
			this->yaichnick1->UseVisualStyleBackColor = true;
			this->yaichnick1->Click += gcnew System::EventHandler(this, &MyForm3::yaichnick1_Click);
			// 
			// yaichnick2
			// 
			...
			this->vlagalische->Location = System::Drawing::Point(168, 125);
			this->vlagalische->Name = L"vlagalische";
			this->vlagalische->Size = System::Drawing::Size(76, 156);
			this->vlagalische->TabIndex = 1;
			this->vlagalische->UseVisualStyleBackColor = true;
			this->vlagalische->Click += gcnew System::EventHandler(this, &MyForm3::vlagalische_Click);
			// 
			// matka
			// 
			...
			this->matka->Location = System::Drawing::Point(94, 100);
			this->matka->Name = L"matka";
			this->matka->Size = System::Drawing::Size(68, 211);
			this->matka->TabIndex = 0;
			this->matka->UseVisualStyleBackColor = true;
			this->matka->Click += gcnew System::EventHandler(this, &MyForm3::matka_Click);
			// 
			// organy
			// 
			...
			this->organy->Location = System::Drawing::Point(1156, 433);
			this->organy->Name = L"organy";
			this->organy->Size = System::Drawing::Size(696, 699);
			this->organy->TabIndex = 24;
			...
			this->tonky->Click += gcnew System::EventHandler(this, &MyForm3::tonky_Click);
			// 
			// tolsty
			// 
			...
			this->tolsty->Location = System::Drawing::Point(422, 453);
			this->tolsty->Name = L"tolsty";
			this->tolsty->Size = System::Drawing::Size(176, 156);
			this->tolsty->TabIndex = 10;
			this->tolsty->UseVisualStyleBackColor = true;
			this->tolsty->Click += gcnew System::EventHandler(this, &MyForm3::tolsty_Click);
			// 
			// pechenorgan
			// 
			...
			this->pechenorgan->Click += gcnew System::EventHandler(this, &MyForm3::pechenorgan_Click);
			// 
			// mochevoy
			// 
			...
			this->mochevoy->Click += gcnew System::EventHandler(this, &MyForm3::mochevoy_Click);
			// 
			// heart
			// 
			...
			this->heart->Location = System::Drawing::Point(220, 57);
			this->heart->Name = L"heart";
			this->heart->Size = System::Drawing::Size(103, 99);
			this->heart->TabIndex = 7;
			this->heart->UseVisualStyleBackColor = true;
			this->heart->Click += gcnew System::EventHandler(this, &MyForm3::heart_Click);
			// 
			// pochki
			// 
			...
			this->pochki->Location = System::Drawing::Point(183, 555);
			this->pochki->Name = L"pochki";
			this->pochki->Size = System::Drawing::Size(117, 106);
			this->pochki->TabIndex = 6;
			this->pochki->UseVisualStyleBackColor = true;
			this->pochki->Click += gcnew System::EventHandler(this, &MyForm3::pochki_Click);
			// 
			// podjeludok
			// 
			...
			this->podjeludok->Location = System::Drawing::Point(16, 427);
			...
			this->podjeludok->Click += gcnew System::EventHandler(this, &MyForm3::podjeludok_Click);
			// 
			// jeludok
			// 
			...
			this->jeludok->Location = System::Drawing::Point(183, 301);
			this->jeludok->Name = L"jeludok";
			this->jeludok->Size = System::Drawing::Size(117, 100);
			this->jeludok->TabIndex = 4;
			this->jeludok->UseVisualStyleBackColor = true;
			this->jeludok->Click += gcnew System::EventHandler(this, &MyForm3::jeludok_Click);
			// 
			// diafragma
			// 
			...
			this->diafragma->Location = System::Drawing::Point(11, 111);
			this->diafragma->Name = L"diafragma";
			this->diafragma->Size = System::Drawing::Size(178, 149);
			this->diafragma->TabIndex = 3;
			this->diafragma->UseVisualStyleBackColor = true;
			this->diafragma->Click += gcnew System::EventHandler(this, &MyForm3::diafragma_Click);
			// 
			// legkie
			// 
			...
			this->legkie->Location = System::Drawing::Point(422, 243);
			this->legkie->Name = L"legkie";
			this->legkie->Size = System::Drawing::Size(176, 128);
			this->legkie->TabIndex = 2;
			this->legkie->UseVisualStyleBackColor = true;
			this->legkie->Click += gcnew System::EventHandler(this, &MyForm3::legkie_Click);
			// 
			// shitovidkaorgan
			// 
			...
			this->shitovidkaorgan->Location = System::Drawing::Point(489, 200);
			...
			this->shitovidkaorgan->Click += gcnew System::EventHandler(this, &MyForm3::shitovidkaorgan_Click);
			// 
			// mozg
			// 
			...
			this->mozg->Location = System::Drawing::Point(458, 25);
			this->mozg->Name = L"mozg";
			this->mozg->Size = System::Drawing::Size(125, 119);
			this->mozg->TabIndex = 0;
			this->mozg->UseVisualStyleBackColor = true;
			this->mozg->Click += gcnew System::EventHandler(this, &MyForm3::mozg_Click);
			// 
			// button2
			// 
			...
			this->button2->Location = System::Drawing::Point(1, -3);
			...
			this->comboBox1->Location = System::Drawing::Point(80, 69);
			...
			this->infotext->Location = System::Drawing::Point(12, 109);
			this->infotext->Name = L"infotext";
			this->infotext->Size = System::Drawing::Size(494, 607);
			this->infotext->TabIndex = 26;
			this->infotext->Visible = false;
			// 
			// webBrowser1
			// 
			this->webBrowser1->Location = System::Drawing::Point(12, 32);
			...
			this->button1->Location = System::Drawing::Point(458, 0);
...
private: System::Void yaichnick1_Click(System::Object^ sender, System::EventArgs^ e) {
	infotext->Visible = true;
	infotext->Enabled = true;
	stroenie->BackgroundImage = System::Drawing::Image::FromFile(Application::StartupPath + "\\строения\\ПЧстроение.png");
	webBrowser1->Navigate(System::IO::Path::Combine(Application::StartupPath + "\\информация\\Яички.htm"));
...
private: System::Void matka_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	infotext->Enabled = true;
	stroenie->BackgroundImage = System::Drawing::Image::FromFile(Application::StartupPath + "\\строения\\ПЧстроение.png");
	webBrowser1->Navigate(System::IO::Path::Combine(Application::StartupPath + "\\информация\\Половой член.htm"));
...
private: System::Void comboBox1_SelectedIndexChanged(System::Object^ sender, System::EventArgs^ e) {
	...
	{
		this->BackgroundImage = System::Drawing::Image::FromFile(Application::StartupPath + "\\фоны\\скелетм.png");
	...
	{
		this->BackgroundImage = System::Drawing::Image::FromFile(Application::StartupPath + "\\фоны\\мышцым.png");
		this->mishechnaya->Visible = true;
		this->mishechnaya->Enabled = true;
		this->mishechnaya->Location = System::Drawing::Point(620, -2);
	...
	{
		this->BackgroundImage = System::Drawing::Image::FromFile(Application::StartupPath + "\\фоны\\нервым.png");
		this->nervi->Visible = true;
		this->nervi->Enabled = true;
		this->nervi->Location = System::Drawing::Point(728, 9);
	...
	{
		this->BackgroundImage = System::Drawing::Image::FromFile(Application::StartupPath + "\\фоны\\лимфам.png");
		this->limfa->Visible = true;
		this->limfa->Enabled = true;
		this->limfa->Location = System::Drawing::Point(858, 5);
	...
	{
		this->BackgroundImage = System::Drawing::Image::FromFile(Application::StartupPath + "\\фоны\\репродуктивнаям.png");
		this->reproduct->Visible = true;
		this->reproduct->Enabled = true;
		this->reproduct->Location = System::Drawing::Point(607, 181);
	...
	{
		this->BackgroundImage = System::Drawing::Image::FromFile(Application::StartupPath + "\\фоны\\органым.png");
		this->organy->Visible = true;
		this->organy->Enabled = true;
		this->organy->Location = System::Drawing::Point(477, 18);
	...
	else if (selectedItem == "Кровеносная система")
	{
		...
		{
			this->BackgroundImage = System::Drawing::Image::FromFile(Application::StartupPath + "\\фоны\\артериим.png");
			this->arterialnaya->Visible = true;
			this->arterialnaya->Enabled = true;
			this->arterialnaya->Location = System::Drawing::Point(781, 9);
		...
		{
			this->BackgroundImage = System::Drawing::Image::FromFile(Application::StartupPath + "\\фоны\\веным.png");
			this->venoznaya->Visible = true;
			this->venoznaya->Enabled = true;
			this->venoznaya->Location = System::Drawing::Point(785, 3);
...
private: System::Void ladon21_Click_1(System::Object^ sender, System::EventArgs^ e) {
	infotext->Visible = true;
	infotext->Enabled = true;
	stroenie->BackgroundImage = System::Drawing::Image::FromFile(Application::StartupPath + "\\строения\\костьстроение.png");
	webBrowser1->Navigate(System::IO::Path::Combine(Application::StartupPath + "\\информация\\Кости кисти.htm"));
}
private: System::Void ladon22_Click_1(System::Object^ sender, System::EventArgs^ e) {
	infotext->Visible = true;
	infotext->Enabled = true;
	stroenie->BackgroundImage = System::Drawing::Image::FromFile(Application::StartupPath + "\\строения\\костьстроение.png");
	webBrowser1->Navigate(System::IO::Path::Combine(Application::StartupPath + "\\информация\\Кости кисти.htm"));
